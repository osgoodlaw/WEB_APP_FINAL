...
class MovieForm(FlaskForm):
    ...
    genre = SelectField('Genre', choices=[('Action', 'Action'), ('Drama', 'Drama'), ('Comedy', 'Comedy'), ('Horror', 'Horror'), ('Sci-Fi', 'Sci-Fi'), ('Other', 'Other')], validators=[DataRequired()])
    ...
    def validate_description(self, description):
        movie = models.Movie.query.filter_by(description=description.data).first()
        if movie:
            raise ValidationError('A movie with this description already exists.')
